...
class _OnlinePlayersScreenState extends State<OnlinePlayersScreen> {
  ...
  List<dynamic> _filterPlayers(List<dynamic> players) {
    return players.where((player) {
      ...
      final vocationClass = vocationFilterKeyFor(player['vocation']);

      if (_selectedVocation != 'all' && vocationClass != _selectedVocation) {
        return false;
      }
    ...
    return Scaffold(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          leading:
                              Icon(MdiIcons.sword, color: Colors.blueAccent),
                        ...
                        ListTile(
                          leading: Icon(MdiIcons.bowArrow,
                        ...
                        ListTile(
                          leading:
                              Icon(MdiIcons.magicStaff, color: Colors.purple),
                        ...
                        ListTile(
                          leading: Icon(MdiIcons.handFrontLeftOutline,
                              color: Colors.teal),
                          title: Text(l10n.translate('monk')),
                          selected: _selectedVocation == 'monk',
                          onTap: () {
                            setState(() => _selectedVocation = 'monk');
                            Navigator.pop(context);
                          },
                        ),
                      ],
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          final data = root['dados'] ?? {};
          final allPlayers =
              _playersLocal ?? (data['players'] as List<dynamic>?) ?? [];
          ...
          Widget buildVocationIcon(String? vocation) {
            switch (vocationClassFor(vocation)) {
              ...
              case VocationClass.paladin:
                return Icon(MdiIcons.bowArrow,
                    color: Colors.orangeAccent, size: 40);
              case VocationClass.sorcerer:
                return Icon(MdiIcons.magicStaff,
                                      ...
                                      if (confirm == true) {
                                        try {
                                          ...
                                          if (response.statusCode == 200) {
                                            ...
                                            if (!mounted) return;
                                            String errorMsg =
                                                '${l10n.translate('kick_error')}: ';
                                            try {
                                              final body = json.decode(utf8
                          ...
                          child: Card(
                            ...
                            child: InkWell(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                    '${l10n.translate('level')}: ${player['level'] ?? '-'}  |  ${l10n.translate('vocation')}: ${player['vocation'] ?? '-'}'),
                                trailing: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.timer,
                                    ...
                                    Text(
                                        formatOnlineTime(player['online_time']),
                ...
                ElevatedButton(
                  onPressed: isSending
                      ...
                      : () async {
                          ...
                          if (reason.isEmpty ||
                            ...
                            setState(() => errorText =
                                AppLocalizations.of(context)
                                    .translate('ban_invalid_reason_duration'));
                            return;
                          }
                          setState(() {
                            isSending = true;
                          ...
                          try {
                            final response =
                                await ApiService.post('players/ban', body: {
                              "action": "ban",
                              "name": player['name'],
                              "duration": duration,
                              "reason": reason,
                            ...
                            if (response.statusCode == 200) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content:
                                        Text('Jogador banido com sucesso!'),
                                    backgroundColor: Colors.green),
                              );
                              // Remove localmente o jogador banido
                              setState(() {
                                _playersLocal?.removeWhere(
                            ...
                            setState(
                                () => errorText = 'Erro ao banir player: $e');
                          } finally {
